...
/**
 *
 * A turret can shoot and aim the balls.
 *
...
public class Turret extends GRTLoggedProcess implements SwitchListener, EncoderListener {
     ...
     */
    public Turret(Shooter shooter, IMotor rotatorMotor, IMotor visorMotor,
...
//        rotationEncoder.removeEncoderListener(this);
    ...
    public void tiltAtSpeed(double speed) {
        visor.setSpeed(speed);
//        visorMotor.set
    }
     ...
     * @param speed
     */
    public void panAtSpeed(double speed) {
        rotator.setSpeed(speed);
    }

    public void shootAtSpeed(double speed) {
        shooter.setSpinnerSpeed(speed);
    }
